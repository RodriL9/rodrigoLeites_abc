...
export default function Home() {
  ...
  const [chatHistory, setChatHistory] = useState([
    { role: "system",
    content: "I am an AI that gives random facts about any topic! Please give me a topic." },
  ]);
  ...
  useEffect(() => {
    ...
    // Retro polish: auto-focus the input
  ...
  const clearChat = async () => {
    ...
    setChatHistory([
      { role: "system", content: "I am an AI that gives random facts about any topic! Please give me a topic."  },
    ]);
  ...
  return (
    <div className={styles.body}>
      ...
      <h1 className={styles.heading1}>Rodrigo Leites-Mena's OpenAI Chat
